...
import com.dfsek.betterend.world.generation.features.generators.AetherCaveGenerator;
import com.dfsek.betterend.world.generation.features.generators.CloudGenerator;
...
public class AetherHighlandsGenerator extends BiomeGenerator {
    private final WorldConfig config;
    public AetherHighlandsGenerator(World world) {
        super(world);
