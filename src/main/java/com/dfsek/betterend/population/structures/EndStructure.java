...
public enum EndStructure implements Structure {
    ...
    END_HOUSE("end_house", 3, Collections.singletonList(new LootFeature(EndStructure.class.getResourceAsStream("/loot/end_house.json"))), new GroundSpawn(- 5)),
    ...
    SHULKER_NEST("shulker_nest", 2, Arrays.asList(new LootFeature(EndStructure.class.getResourceAsStream("/loot/shulker_nest.json")), new EntityFeature(2, 6, EntityType.SHULKER)), new GroundSpawn(0)),
    ...
    GOLD_DUNGEON("gold_dungeon", 1, Arrays.asList(new LootFeature(EndStructure.class.getResourceAsStream("/loot/gold_dungeon.json")), new PersistentDataFeature(new NamespacedKey(BetterEnd.getInstance(), "valkyrie-spawner"))), new AirSpawn(96, 0)),
